...
UserController.updateOne = (req, res) => __awaiter(this, void 0, void 0, function* () {
    const body = req.body;
    const user = req.user;
    const updatedFields = lodash_1.default.pick(body, ['username', 'score',]);
    if (!user) {
        return res.sendStatus(403);
    }
    try {
        const doc = yield user_model_1.User.findByIdAndUpdate(user.id, updatedFields);
...
UserController.signup = (req, res) => __awaiter(this, void 0, void 0, function* () {
    ...
    try {
        const exsistedUser = yield user_model_1.User.findOne({ username });
        if (exsistedUser) {
